...
Write-Host "Mod peer : the mod binds 127.0.0.1:14601 by default; the backend pins"
Write-Host "           that peer, so keep the mod's local port fixed to re-attach"
Write-Host "           after a Minecraft restart (see docs/main-backend-compatibility.md 2.0)."
